...
//! 
//! This module contains the AnimationTrackCollection struct for managing
//! multiple animation tracks and organizing them by type and target.
...
impl AnimationTrackCollection {
    ...
    /// Get all target IDs in collection
    ...
    /// Get values at time for all enabled tracks
    ...
    /// Get values at time for specific target
...
impl Default for AnimationTrackCollection {
    fn default() -> Self {
        Self::new("Default Collection".to_string())
    }
}
