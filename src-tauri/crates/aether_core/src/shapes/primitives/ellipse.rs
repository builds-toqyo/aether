...
//! 
//! This module provides the Ellipse shape implementation with support
//! for rotation and full transformation capabilities.
...
mod tests {
    ...
    fn test_ellipse_area_perimeter() {
        ...
        // Perimeter approximation should be reasonable
        let perimeter = ellipse.perimeter();
        assert!(perimeter > 180.0 && perimeter < 200.0); // Reasonable range
    }
    ...
    fn test_ellipse_contains_point() {
        ...
        assert!(ellipse.contains_point(50.0, 50.0)); // Center
        assert!(ellipse.contains_point(85.0, 50.0)); // Edge
        assert!(ellipse.contains_point(70.0, 50.0)); // Inside
        assert!(!ellipse.contains_point(95.0, 50.0)); // Outside
        assert!(!ellipse.contains_point(50.0, 75.0)); // Outside
    }
    ...
    fn test_rotated_ellipse_contains_point() {
        ...
        assert!(ellipse.contains_point(50.0, 50.0)); // Center
        assert!(ellipse.contains_point(50.0, 85.0)); // Edge (rotated)
        assert!(!ellipse.contains_point(85.0, 50.0)); // Outside (rotated)
    }
    ...
    fn test_rotated_ellipse_bounds() {
        ...
        // Rotated ellipse should have larger bounds
