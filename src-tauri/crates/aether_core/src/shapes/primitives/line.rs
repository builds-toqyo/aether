...
mod tests {
    ...
    fn test_line_contains_point() {
        ...
        assert!(line.contains_point(50.0, 0.0));
        assert!(line.contains_point(50.0, 4.0));
        assert!(!line.contains_point(50.0, 6.0));
        assert!(!line.contains_point(150.0, 0.0));
    }
    ...
    fn test_line_area_perimeter() {
        ...
        assert_eq!(line.area(), 500.0);
        assert_eq!(line.perimeter(), 210.0);
    ...
    fn test_line_bounds() {
        ...
        assert_eq!(bounds.max_x, 103.0);
        assert_eq!(bounds.max_y, 83.0);
    ...
    fn test_line_to_path() {
        ...
        assert!(path.closed);
        assert!((path.area() - 1000.0).abs() < 0.001);
    }
