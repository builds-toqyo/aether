//! Transform and bounding box utilities
//! 
//! This module provides 2D transformation matrices and bounding box operations
//! for shape primitives.
...
mod tests {
    ...
    fn test_transform_combine() {
        ...
        assert_eq!(point, (25.0, 70.0)); // (10*2+5, 20*3+10)
    }
