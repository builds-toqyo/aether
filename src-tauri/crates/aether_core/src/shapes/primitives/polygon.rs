...
//! 
//! This module provides the Polygon shape implementation with support
//! for regular polygons and full geometric operations.
...
impl Polygon {
    ...
    /// Create regular polygon with rotation
    ...
    pub fn simplify(&self, tolerance: f64) -> Self {
        ...
        for (i, &vertex) in self.vertices.iter().enumerate() {
            ...
            // Check if current vertex is collinear with neighbors
...
mod tests {
    ...
    fn test_polygon_contains_point() {
        ...
        assert!(square.contains_point(1.0, 1.0)); // Inside
        assert!(!square.contains_point(11.0, 5.0)); // Outside
        assert!(!square.contains_point(5.0, 11.0)); // Outside
    }
    ...
    fn test_rotated_regular_polygon() {
        ...
        // First vertex should be rotated by 45 degrees
