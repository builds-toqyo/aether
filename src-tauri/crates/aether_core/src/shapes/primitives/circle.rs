...
//! 
//! This module provides the Circle shape implementation with full
//! transformation and geometric operations.
...
mod tests {
    ...
    fn test_circle_contains_point() {
        ...
        assert!(circle.contains_point(50.0, 50.0)); // Center
        assert!(circle.contains_point(70.0, 50.0)); // Edge
        assert!(circle.contains_point(65.0, 50.0)); // Inside
        assert!(!circle.contains_point(80.0, 50.0)); // Outside
        assert!(!circle.contains_point(50.0, 80.0)); // Outside
    }
