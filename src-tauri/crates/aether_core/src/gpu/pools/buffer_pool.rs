...
impl BufferPool {
    ...
    /// Allocate a buffer with the given size and usage
    ...
    /// Find an available buffer with compatible size and usage
...
/// Entry for a buffer in the pool
#[derive(Debug)]
...
mod tests {
    ...
    fn test_buffer_pool_stats() {
        let stats = BufferPoolStats {
            active_buffers: 3,
            available_buffers: 2,
            total_memory_bytes: 512 * 1024, // 512KB
        };
    ...
    fn create_mock_device() -> Device {
        // This would need a proper mock implementation in real tests
